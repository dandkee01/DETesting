...
Key   := INDEX(Key_subject,'~key::currcarr::inquiry_history::20240808::trans_id');
OUTPUT(SORT(Key,-dt_effective_first),named('currcarr_Key_subject'));
OUTPUT(SORT(Key,dt_effective_first),named('currcarr_Key_subjectold'));
