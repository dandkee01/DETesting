...
Key   := INDEX(Key_subject,'~key::dd::inquiry_history::20240514d::trans_id');
OUTPUT(SORT(Key,-dt_effective_first),named('DD_Key_subject'));
OUTPUT(SORT(Key,dt_effective_first),named('DD_Key_subjectold'));
