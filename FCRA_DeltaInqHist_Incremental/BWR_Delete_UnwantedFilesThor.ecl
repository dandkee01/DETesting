IMPORT STD;
    ...
    AllFiles := NOTHOR(STD.File.LogicalFileList('*thor::base::fcra::delta_inq_hist::20250130::delta_key', TRUE,TRUE)(modified[1..10] <= '2025-02-12' and owner IN [ 'Dandke01','dandke01']  and cluster IN ['hthor__dev_eclagent_1','thor400_198', 'thor20_167_dev','thor400_126','thor20_166_sta']));
    //thor::base::fcra::delta_inq_hist::20250210::delta_key
    AllFilesDS := AllFiles;
