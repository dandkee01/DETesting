IMPORT STD;
    ...
    //AllFiles := NOTHOR(STD.File.LogicalFileList('thor*claimsdiscoveryproperty*kcd*20241013*', TRUE,TRUE)(modified[1..10] <= '2024-10-15' and owner IN [ 'Dandke01','dandke01']  and cluster IN ['hthor__dev_eclagent_1','thor400_198', 'thor20_167_dev','thor400_126','thor20_166_sta']));
    AllFiles := NOTHOR(STD.File.LogicalFileList('thor*claimsdiscoveryproperty*20241016*', TRUE,TRUE)(modified[1..10] <= '2024-10-15' and owner IN [ 'Dandke01','dandke01']  and cluster IN ['hthor__dev_eclagent_1','thor400_198', 'thor20_167_dev','thor400_126','thor20_166_sta']));
