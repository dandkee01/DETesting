...
//after_project := DATASET(rc_file, CustomerSupport.NonStandard_Layouts.Layout_transaction_log_online, THOR);
//after_project := DATASET('~base::ccfc_trano::transaction_log_online::qa::trans_online_id', CustomerSupport.NonStandard_Layouts.Layout_transaction_log_online, THOR);
//after_project := DATASET('~base::cc_trano::transaction_log_online::qa::trans_online_id', CustomerSupport.NonStandard_Layouts.Layout_transaction_log_online, THOR);
after_project := DATASET('~base::mvr_trano::transaction_log_online::qa::trans_online_id', CustomerSupport.NonStandard_Layouts.Layout_transaction_log_online, THOR);
