...
Key   := INDEX(Key_subject,'~key::cdscauto::inquiry_history::20240520b::trans_id');
OUTPUT(SORT(Key,-dt_effective_first),named('CDSC_Key_subject'));
OUTPUT(SORT(Key,dt_effective_first),named('CDSC_Key_subjectold'));
