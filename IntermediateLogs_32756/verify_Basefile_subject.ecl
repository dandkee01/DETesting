...
//rc_file := '~base::cdsc_trano::transaction_log_online::qa::trans_online_id';    //Remote copied file from Prod
 ...
 //after_project := DATASET('~base::dd::inquiry_history::qa::id',CustomerSupport.Layouts.Layout_InquiryHistory_DD_Data, THOR);
 //after_project := DATASET('~base::ccfc::inquiry_history::20240515::id', CustomerSupport.Layouts.Layout_InquiryHistory_CCFC_Data, THOR);
 
rc_file := '~base::mbsi::inquiry_history::20240611::id';    //Remote copied file from Prod

after_project := DATASET(rc_file, CustomerSupport.Layouts.Layout_NCF_InquiryHistory_Data_new, THOR);
