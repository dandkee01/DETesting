...
//rc_file := '~base::cdsc_trano::transaction_log_online::qa::trans_online_id';    //Remote copied file from Prod
 ...
 after_project := DATASET('~base::dd::inquiry_history::20240605::id',CustomerSupport.Layouts.Layout_InquiryHistory_DD_Data, THOR);
 //after_project := DATASET('~base::ccfc::inquiry_history::20240603::id', CustomerSupport.Layouts.Layout_InquiryHistory_CCFC_Data, THOR);
 
 //after_project := DATASET('~base::cdscauto::inquiry_history::20240604::id', CustomerSupport.Layouts.Layout_InquiryHistory_CDSC_Auto_Data, THOR);
 
 
//after_project := DATASET(after_project, CustomerSupport.Layouts.Layout_InquiryHistory_CDSC_Auto_Data, THOR);
