...
Key   := INDEX(Key_subject,'~ key::ccfc::inquiry_history::20240515b::trans_id');
OUTPUT(SORT(Key,-dt_effective_first),named('CCFC_Key_subject'));
OUTPUT(SORT(Key,dt_effective_first),named('CCFC_Key_subjectold'));
