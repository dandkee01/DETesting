...
/*before_project := DATASET('~thor::base::currentcarrier::20231227a::delta_key.txt',lay1, THOR);
OUTPUT(COUNT(before_project),named('before_project'));*/

after_project := DATASET('~thor::base::currentcarrier::qa::delta_key.txt',lay1, THOR);
