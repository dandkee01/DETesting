...
//after_project := DATASET('~base::cluempo_to::transaction_log_online::qa::trans_online_id',CustomerSupport.Layouts.Layout_transaction_log_online_trano,THOR);
//after_project := DATASET('~base::fcra_mbsi_trano::transaction_log_online::qa::trans_online_id',CustomerSupport.Layouts.Layout_transaction_log_online_trano, THOR);
after_project := DATASET('~base::ncf_transo::transaction_log_online::qa::trans_online_id',CustomerSupport.Layouts.Layout_transaction_log_online_trano, THOR);
//after_project := DATASET('~base::mbsi_trano::transaction_log_online::qa::trans_online_id',CustomerSupport.Layouts.Layout_transaction_log_online_trano, THOR);
