...
//mbsi_trano
mbsi_trano  := Adhoc_Script('~base::mbsi_trano::transaction_log_online::qa::trans_online_id',
                            CustomerSupport.Layouts.Layout_transaction_log_online_trano, 'MBSI_TranO',
