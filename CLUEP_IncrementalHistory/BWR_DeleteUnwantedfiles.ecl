IMPORT STD;
    ...
    AllFiles := NOTHOR(STD.File.LogicalFileList('*clueproperty*20240918*', TRUE,TRUE)(modified[1..10] <= '2024-09-20' and owner IN [ 'Dandke01','dandke01']  and cluster IN ['hthor__dev_eclagent_1','thor400_198', 'thor20_167_dev','thor400_126','thor20_166_sta']));
