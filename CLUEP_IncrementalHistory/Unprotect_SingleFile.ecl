...
LF_DS_base := STD.File.LogicalFileList('thor::base::clueproperty::20240916::account::requirements');
OUTPUT(LF_DS_base);
//LF_DS_key := STD.File.LogicalFileList('*key*clueauto*kcd*20240701*');
LF_DS_key := STD.File.LogicalFileList('thor::base::clueproperty::20240916::inqhist::subject');
OUTPUT(LF_DS_key);
