...
NewpayloadKey := INDEX(PayloadRec,'~thor::key::claimsdiscoveryauto::inqhist::kcd::autokey::payload_qa');
NewpayloadKey(delta_ind=1);
NewpayloadKey(delta_ind=2);
NewpayloadKey(delta_ind=3);