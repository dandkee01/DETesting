...
/* AppendDeltaSubject -- Pass new records with subjects that exist in Header.
expected result -- for these records delta_ind should be 1
*/
  ...
  OUTPUT(DailySub,named('DailySub'));
